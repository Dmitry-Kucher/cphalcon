...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, check) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "defined", NULL, 225, &_2);
	zephir_check_call_status();
	if (zephir_is_true(_3)) {
		ZEPHIR_SINIT_VAR(_4$$5);
		ZVAL_STRING(&_4$$5, "Imagick::IMAGICK_EXTNUM", 0);
		ZEPHIR_CALL_FUNCTION(&_5$$5, "constant", NULL, 187, &_4$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __construct) {
	...
	if ((zephir_file_exists(_2 TSRMLS_CC) == SUCCESS)) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$4, "realpath", NULL, 64, _3$$4);
		zephir_check_call_status();
		zephir_update_property_this(this_ptr, SL("_realpath"), _4$$4 TSRMLS_CC);
		...
		if (!(zephir_is_true(_6$$4))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_8$$5, "phalcon/image/adapter/imagick.zep", 85 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		if (!(zephir_is_true(_12$$4))) {
			...
			ZEPHIR_CALL_FUNCTION(&_15$$6, "constant", NULL, 187, &_14$$6);
			zephir_check_call_status();
		...
		if (_20$$8) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_21$$9, "phalcon/image/adapter/imagick.zep", 101 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		zephir_update_property_this(this_ptr, SL("_realpath"), _30$$8 TSRMLS_CC);
	}
	...
	zephir_check_call_status();
	zephir_update_property_this(this_ptr, SL("_height"), _34 TSRMLS_CC);
	_35 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
	ZEPHIR_CALL_METHOD(&_36, _35, "getimagetype", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_this(this_ptr, SL("_type"), _36 TSRMLS_CC);
	...
	zephir_update_property_this(this_ptr, SL("_mime"), _39 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _reflection) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_20$$7, "constant", &_21, 187, &_19$$7);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_25$$7, "constant", &_21, 187, &_19$$7);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_19$$7);
		ZVAL_STRING(&_19$$7, "Imagick::CHANNEL_ALPHA", 0);
		ZEPHIR_CALL_FUNCTION(&_26$$7, "constant", &_21, 187, &_19$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_22$$7);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_37$$10, "constant", &_21, 187, &_36$$10);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_46$$10, "constant", &_21, 187, &_36$$10);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_34$$10);
		ZVAL_LONG(_34$$10, 0);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_52$$13, "constant", &_21, 187, &_51$$13);
		zephir_check_call_status();
	...
	zephir_check_call_status();
	zephir_update_property_this(this_ptr, SL("_width"), _62 TSRMLS_CC);
	_63 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
	ZEPHIR_CALL_METHOD(&_64, _63, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_this(this_ptr, SL("_height"), _64 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _watermark) {
	...
	zval *image, *offsetX_param = NULL, *offsetY_param = NULL, *opacity_param = NULL, *watermark = NULL, *ret = NULL, *_0 = NULL, *_1 = NULL, *_2, *_3$$3, _4$$3 = zval_used_for_init, *_5$$3 = NULL, *_7$$3 = NULL, *_8$$3 = NULL, *_9$$3, *_10$$3 = NULL;
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_5$$3, "constant", &_6, 187, &_4$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_7$$3);
		ZVAL_LONG(_7$$3, offsetX);
		ZEPHIR_INIT_NVAR(_8$$3);
		ZVAL_LONG(_8$$3, offsetY);
		ZEPHIR_CALL_METHOD(&ret, _3$$3, "compositeimage", NULL, 0, watermark, _5$$3, _7$$3, _8$$3);
		zephir_check_call_status();
		if (!ZEPHIR_IS_TRUE_IDENTICAL(ret)) {
		...
		ZEPHIR_CALL_METHOD(&_10$$3, _9$$3, "nextimage", NULL, 0);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _text) {
	...
	zval *text_param = NULL, *offsetX = NULL, *offsetY = NULL, *opacity_param = NULL, *r_param = NULL, *g_param = NULL, *b_param = NULL, *size_param = NULL, *fontfile_param = NULL, *draw = NULL, *color = NULL, *gravity = NULL, _0, _1, _2, _3, *_4, *_25, *_26, *_5$$4, *_6$$5, _8$$8, _10$$10, _11$$12, _12$$13, _13$$17, _14$$18, _15$$20, _16$$21, _17$$27, _18$$28, _19$$30, _20$$31, _21$$35, _22$$36, _23$$38, _24$$39, *_27$$40, *_28$$40 = NULL, *_29$$40, *_30$$40 = NULL;
	...
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_LONG(&_3, b);
	ZEPHIR_CALL_FUNCTION(&color, "sprintf", NULL, 184, &_0, &_1, &_2, &_3);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_4);
			...
			if (Z_TYPE_P(offsetY) == IS_LONG) {
				...
				if (zephir_is_true(offsetX)) {
					...
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 187, &_13$$17);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_SINIT_VAR(_14$$18);
						ZVAL_STRING(&_14$$18, "Imagick::GRAVITY_NORTHEAST", 0);
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 187, &_14$$18);
						zephir_check_call_status();
					}
				} else {
					ZEPHIR_INIT_NVAR(offsetX);
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 187, &_15$$20);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_SINIT_VAR(_16$$21);
						ZVAL_STRING(&_16$$21, "Imagick::GRAVITY_NORTH", 0);
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 187, &_16$$21);
						zephir_check_call_status();
					}
				}
			}
				...
				if (Z_TYPE_P(offsetY) == IS_BOOL) {
					if (zephir_is_true(offsetY)) {
						...
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 187, &_17$$27);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_SINIT_VAR(_18$$28);
							ZVAL_STRING(&_18$$28, "Imagick::GRAVITY_SOUTH", 0);
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 187, &_18$$28);
							zephir_check_call_status();
						}
					} else {
						ZEPHIR_INIT_NVAR(offsetY);
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 187, &_19$$30);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_SINIT_VAR(_20$$31);
							ZVAL_STRING(&_20$$31, "Imagick::GRAVITY_WEST", 0);
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 187, &_20$$31);
							zephir_check_call_status();
						}
					}
				} else {
					if (Z_TYPE_P(offsetY) == IS_LONG) {
						...
						if (x < 0) {
							...
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 187, &_21$$35);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, (x * -1));
								ZEPHIR_SINIT_VAR(_22$$36);
								ZVAL_STRING(&_22$$36, "Imagick::GRAVITY_NORTHEAST", 0);
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 187, &_22$$36);
								zephir_check_call_status();
							}
						} else {
							ZEPHIR_INIT_NVAR(offsetX);
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 187, &_23$$38);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, 0);
								ZEPHIR_SINIT_VAR(_24$$39);
								ZVAL_STRING(&_24$$39, "Imagick::GRAVITY_NORTHWEST", 0);
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", &_9, 187, &_24$$39);
								zephir_check_call_status();
							}
						}
					}
	...
	ZEPHIR_INIT_VAR(_26);
	ZVAL_LONG(_26, 0);
	ZEPHIR_CALL_METHOD(NULL, _25, "setiteratorindex", NULL, 0, _26);
	zephir_check_call_status();
	while (1) {
		_27$$40 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_INIT_NVAR(_28$$40);
		ZVAL_LONG(_28$$40, 0);
		ZEPHIR_CALL_METHOD(NULL, _27$$40, "annotateimage", NULL, 0, draw, offsetX, offsetY, _28$$40, text);
		zephir_check_call_status();
		_29$$40 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_CALL_METHOD(&_30$$40, _29$$40, "nextimage", NULL, 0);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _mask) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_7$$3, "constant", &_8, 187, &_6$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_4$$3);
		ZVAL_LONG(_4$$3, 0);
		...
		zephir_check_call_status();
		if (!ZEPHIR_IS_TRUE_IDENTICAL(ret)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "Imagick::compositeImage failed", "phalcon/image/adapter/imagick.zep", 531);
			return;
		}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _background) {
	...
	while (1) {
		...
		if (!(zephir_is_true(_9$$3))) {
			...
			ZEPHIR_CALL_FUNCTION(&_12$$4, "constant", &_13, 187, &_11$$4);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_17$$3, "constant", &_13, 187, &_16$$3);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_16$$3);
		ZVAL_STRING(&_16$$3, "Imagick::CHANNEL_ALPHA", 0);
		ZEPHIR_CALL_FUNCTION(&_18$$3, "constant", &_13, 187, &_16$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_25$$3, "constant", &_13, 187, &_16$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_19$$3);
		ZVAL_LONG(_19$$3, 0);
		...
		zephir_check_call_status();
		if (!ZEPHIR_IS_TRUE_IDENTICAL(ret)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "Imagick::compositeImage failed", "phalcon/image/adapter/imagick.zep", 570);
			return;
		}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _save) {
	...
	if (ZEPHIR_IS_LONG(_8, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&fp, "fopen", NULL, 281, file, &_11$$3);
		zephir_check_call_status();
		...
		ZVAL_STRING(&_13$$4, "jpg", 0);
		ZEPHIR_CALL_FUNCTION(&_14$$4, "strcasecmp", &_9, 19, ext, &_13$$4);
		zephir_check_call_status();
		_15$$4 = ZEPHIR_IS_LONG(_14$$4, 0);
		if (!(_15$$4)) {
			ZEPHIR_SINIT_NVAR(_13$$4);
			ZVAL_STRING(&_13$$4, "jpeg", 0);
			ZEPHIR_CALL_FUNCTION(&_16$$4, "strcasecmp", &_9, 19, ext, &_13$$4);
			zephir_check_call_status();
		...
		if (_15$$4) {
			...
			ZEPHIR_CALL_FUNCTION(&_19$$5, "constant", NULL, 187, &_18$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, _render) {
	...
	int quality, ZEPHIR_LAST_CALL_STATUS;
	zval *extension_param = NULL, *quality_param = NULL, *image = NULL, *_0 = NULL, *_1 = NULL, *_2, _3, *_4 = NULL, _6$$4 = zval_used_for_init, *_7$$4 = NULL, *_9$$4 = NULL, *_12$$4, _10$$5, *_11$$5 = NULL;
	zval *extension = NULL;
	...
	if (ZEPHIR_IS_LONG_IDENTICAL(_4, 0)) {
		...
		ZVAL_STRING(&_6$$4, "jpg", 0);
		ZEPHIR_CALL_FUNCTION(&_7$$4, "strcasecmp", &_5, 19, extension, &_6$$4);
		zephir_check_call_status();
		_8$$4 = ZEPHIR_IS_LONG_IDENTICAL(_7$$4, 0);
		if (!(_8$$4)) {
			ZEPHIR_SINIT_NVAR(_6$$4);
			ZVAL_STRING(&_6$$4, "jpeg", 0);
			ZEPHIR_CALL_FUNCTION(&_9$$4, "strcasecmp", &_5, 19, extension, &_6$$4);
			zephir_check_call_status();
		...
		if (_8$$4) {
			...
			ZEPHIR_CALL_FUNCTION(&_11$$5, "constant", NULL, 187, &_10$$5);
			zephir_check_call_status();
