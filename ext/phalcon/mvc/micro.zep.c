...
PHP_METHOD(Phalcon_Mvc_Micro, setService) {
	...
	if (Z_TYPE_P(dependencyInjector) != IS_OBJECT) {
		...
		ZEPHIR_CALL_METHOD(NULL, dependencyInjector, "__construct", NULL, 171);
		zephir_check_call_status();
		zephir_update_property_this(this_ptr, SL("_dependencyInjector"), dependencyInjector TSRMLS_CC);
	}
	ZEPHIR_INIT_VAR(_0);
	...
	ZEPHIR_RETURN_CALL_METHOD(dependencyInjector, "set", NULL, 295, serviceName, definition, _0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, hasService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(dependencyInjector, "has", NULL, 296, serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, getService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(dependencyInjector, "get", NULL, 297, serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, getSharedService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(dependencyInjector, "getshared", NULL, 298, serviceName);
	zephir_check_call_status();
	RETURN_MM();
